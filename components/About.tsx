        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-1/2 mt-8 lg:mt-0">
            <div className="text-container text-center lg:text-left">
              ...
              <p className='text-base lg:text-lg lg:leading-relaxed px-4 lg:px-0'>
              ...
              <ul className="list-disc list-inside mt-4 text-base lg:text-lg lg:leading-relaxed">
              ...
              <ul className='flex mt-6 lg:mt-10 px-4 lg:px-0'>
                <li className='text-xl lg:text-3xl font-bold pr-4 '>9.4</li>
                <li className='pr-7 text-base lg:text-lg'>Odlična<br/>ocjena</li>
                <li className='text-xl lg:text-3xl font-bold pr-4 '>24</li>
